...
<div id="eventContainer" class="p-5 m-5 bg-secondary rounded min-height">
    <div class="d-flex justify-content-start m-auto link-light">
        <button type="button" class="btn btn-secondary"><a href="/organicunits/{{$event->organicunit->organicunitid}}/events"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
