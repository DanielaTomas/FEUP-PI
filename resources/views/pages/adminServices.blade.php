                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <label for="question2" class="form-label">Question 2 (<i>optional</i>)</label>
                            <div>
                            ...
                            <label for="question3" class="form-label">Question 3 (<i>optional</i>)</label>
                            <div>
                            ...
                            <label for="question4" class="form-label">Question 4 (<i>optional</i>)</label>
                            <div>
                            ...
                            <label for="question5" class="form-label">Question 5 (<i>optional</i>)</label>
                            <div>
                            ...
                            <label for="question6" class="form-label">Question 6 (<i>optional</i>)</label>
                            <div>
                            ...
                            <label for="question7" class="form-label">Question 7 (<i>optional</i>)</label>
                            <div>
                            ...
                            <label for="question8" class="form-label">Question 8 (<i>optional</i>)</label>
                            <div>
                            ...
                            <label for="question9" class="form-label">Question 9 (<i>optional</i>)</label>
                            <div>
                            ...
                            <label for="question10" class="form-label">Question 10 (<i>optional</i>)</label>
                            <div>
