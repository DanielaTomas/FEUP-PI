...
@if($question->question2 != null)
    <label for="atribute2" class="form-label">{{$question->question2}}<span><b class="text-danger">*</b></span></label>
...
@if($question->question3 != null)
    <label for="atribute3" class="form-label">{{$question->question3}}<span><b class="text-danger">*</b></span></label>
...
@if($question->question4 != null)
    <label for="atribute4" class="form-label">{{$question->question4}}<span><b class="text-danger">*</b></span></label>
...
@if($question->question5 != null)
    <label for="atribute5" class="form-label">{{$question->question5}}<span><b class="text-danger">*</b></span></label>
...
@if($question->question6 != null)
    <label for="atribute6" class="form-label">{{$question->question6}}<span><b class="text-danger">*</b></span></label>
...
@if($question->question7 != null)
    <label for="atribute7" class="form-label">{{$question->question7}}<span><b class="text-danger">*</b></span></label>
...
@if($question->question8 != null)
    <label for="atribute8" class="form-label">{{$question->question8}}<span><b class="text-danger">*</b></span></label>
...
@if($question->question9 != null)
    <label for="atribute9" class="form-label">{{$question->question9}}<span><b class="text-danger">*</b></span></label>
...
@if($question->question10 != null)
    <label for="atribute10" class="form-label">{{$question->question10}}<span><b class="text-danger">*</b></span></label>
