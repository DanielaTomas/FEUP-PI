  ...
  <div class="row align-items-center">
      <div class="col-md-8 mb-3 mb-sm-0">
        ...
        <div class="text-sm op-5"> 
            ...
            <a class="text-black mr-2" href="#">{{$service->contactperson}}</a>
            ...
            <a class="text-black mr-2" href="#">{{$service->email}}</a>
            ...
            <div class="row text-center op-7">
              <div class="col px-1"><i class="ion-connection-bars icon-1x"></i><span class="d-block text-sm">Sent: <br>{{$service->datecreated}}</span></div>
                ...
                <div class="col px-1"><i class="ion-ios-eye-outline icon-1x"></i><a class="text-black mr-2" href="/show.service/{{$service->serviceid}}"><span class="d-block text-sm">View >></span></a></div>
                  <div class="col px-1"><i class="ion-ios-eye-outline icon-1x"></i><a class="text-black mr-2" href="/edit.service/{{ $service->serviceid }}" title="Edit service request"><span class="d-block text-sm">Edit >></span></a></div>
