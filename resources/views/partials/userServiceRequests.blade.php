        ...
        <div class="col-md-6 op-7">
            <div class="row text-center op-7">
              <div class="col px-1"><i class="ion-connection-bars icon-1x"></i><span class="d-block text-sm">Sent: <br>{{$service->datecreated}}</span></div>
                ...
                <div class="col px-1"><i class="ion-ios-eye-outline icon-1x"></i><a class="text-black mr-2" href="/show.service.request/{{$service->serviceid}}"><span class="d-block text-sm">View >></span></a></div>
